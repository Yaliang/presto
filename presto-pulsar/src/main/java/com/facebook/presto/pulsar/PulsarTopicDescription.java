...
public class PulsarTopicDescription
{
    ...
    private final PulsarTopicFieldGroup key;
    private final PulsarTopicFieldGroup message;
    ...
    public PulsarTopicDescription(
            ...
            @JsonProperty("key") PulsarTopicFieldGroup key,
            @JsonProperty("message") PulsarTopicFieldGroup message)
    {
    ...
    @JsonProperty
    public PulsarTopicFieldGroup getKey()
    {
        return key;
    }

    @JsonProperty
    public PulsarTopicFieldGroup getMessage()
    {
        return message;
    }
