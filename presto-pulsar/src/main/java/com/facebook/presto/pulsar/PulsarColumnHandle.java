...
/**
 * Pulsar specific connector column handle.
 */
public final class PulsarColumnHandle
        implements DecoderColumnHandle, Comparable<PulsarColumnHandle>
{
    ...
    @Override
    public int compareTo(PulsarColumnHandle otherHandle)
    {
