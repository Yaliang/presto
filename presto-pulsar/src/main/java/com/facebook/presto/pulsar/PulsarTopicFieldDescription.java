...
/**
 * Json description to parse a single field from a Pulsar topic message. See {@link com.facebook.presto.pulsar.PulsarTopicDescription} for more details.
 */
public final class PulsarTopicFieldDescription
{
    ...
    PulsarColumnHandle getColumnHandle(String connectorId, boolean keyDecoder, int index)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        PulsarTopicFieldDescription other = (PulsarTopicFieldDescription) obj;
